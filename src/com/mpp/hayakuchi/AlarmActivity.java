...
public class AlarmActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setPrefer();
     	...
     	// ?��??��??��?Item?�动?�数组对应�??��?
    	listItemAdapter = new MyAdapter(AlarmActivity.this, listItem,// ?�据�?
    	R.layout.time_list,// ListItem?�XML实现
    	// ?��??��?与ImageItem对�??��?�?
    	new String[] {  "clockTime","levelImg" },
    	// ImageItem?�XML?�件?�面?��?个ImageView,两个TextView ID
...
//    					Toast.makeText(AlarmActivity.this, "?��?�? + map2.get("clockTimeHour"), Toast.LENGTH_SHORT).show();
    	...
    	bt_back.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				case MotionEvent.ACTION_DOWN:
					...
					Music.playPress(AlarmActivity.this);
					break;
